...
<%
    Collection<?> products = (Collection<?>) request.getAttribute("productscarpet");
    if (products == null) {
        response.sendRedirect("./prodottoCliente?source=/prodottiClienteC.jsp");
        return;
    }
